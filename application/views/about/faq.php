...
<script
	src="<?php echo base_url().'style/' ?>scripts/jquery.simpleFAQ-0.7.min.js"></script>
<script>
$(function(){
	$('#faq').simpleFAQ();
});
...
<div class="content_block">
 ...
 <div class="top_title">
  <div class="wraper">
   <h2>常见问题<span>不学不成，不问不知！</span></h2>
   <ul>
 ...
 <div class="faq_list">
  <ul class="filter">
   <li class="active all"><a href="#all">全部</a></li>
   <li class="business"><a href="#business">文书服务</a></li>
   <li class="technical"><a href="#technical">留学服务</a></li>
   <li class="miscellaneous"><a href="#miscellaneous">其他</a></li>
  </ul>
  <ul id="faq">
